                ...
                <div class="row justify-content-start" style="margin-top: 0.5rem; margin-bottom: 5rem;">
                            ...
                            <div class="col-md-5" style="width: 50rem;">
                                ...
                                <td><?php echo $duedate ?></td>
                                    ...
                                    <?php 
                                    if($renewals)
                                        echo "<a href=\"renew_request.php?id=".$bookid."\" class=\"btn btn-success btn-sm\">Renew</a>";
                                    ?>
                                    <a href="return_request.php?id=<?php echo $bookid; ?>" class="btn btn-primary btn-sm">Return</a>
                                    </center></td>
                                </tr>
                                <?php }} ?>
                                </tbody>
